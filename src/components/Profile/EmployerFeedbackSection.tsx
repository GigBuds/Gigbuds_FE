...
interface EmployerFeedbackSectionProps {
  employerId: string;
}
  ...
  useEffect(() => {
    const fetchFeedbacks = async () => {
      try {
        ...
        // Fetch feedback that employer received from job seekers
        const response = await feedbackApi.getFeedbacksByAccountId(employerId, FeedbackType.JobSeekerToEmployer);
        ...
        console.error('Error fetching employer feedbacks:', err);
      ...
      <div className="p-6">
        {feedbacks.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-gray-500">Chưa có đánh giá từ ứng viên nào</p>
          </div>
        ) : (
          <>
            {/* Rating Summary */}
...
export default EmployerFeedbackSection; 
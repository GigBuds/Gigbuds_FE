...
import { Job, JobPost } from "@/types/jobPost.types";
...
const ManageJobPost = () => {
  ...
  const [jobPostings, setJobPostings] = useState<JobPost[]>([]); // Fixed: added proper typing
  ...
  try {
    ...
    if (response ) {
      ...
      setJobPostings(response.items || []); // Fixed: ensure items is an array
